...
&nbsp;&nbsp;&nbsp;&nbsp;Следующим шагом стал расчёт трафика. Для этого был высчитан вес одного видео-ролика и умножив его на количество просмотров в день и на количество активных пользователей в день - был получен общий трафик роликов, проходящий через сервера. Но для расчета общего объема требуется учитывать мета-данные и подгрузку комментариев. Для этого путем эксперимента был высчитано среднее количество символов в комментарии. Зная кодировку - можно рассчитать вес подгрузки:  
...
**Ежедневный исходящий трафик роликов**: &nbsp;&nbsp;
$DAU \times \text{Продолжительность сессии} \times\text{Вес ролика} = 117 \times 25.78 \times 875.736 \times 10^6=2579.6 Pb$  &nbsp;&nbsp;&nbsp;&nbsp; **(3)**


&nbsp;&nbsp;&nbsp;&nbsp;Для расчета ежедневного трафика нагрузки на память серверов была найдена информация сколько ежеминутно выкладывается роликов [^7] и, зная вес одного среднего по продолжительности видео, был найден общий объем:


**Количество роликов выложенных пользователями за день**:&nbsp;&nbsp; $\text{Роликов в минуту} \times 60 \times 24 = 16{,}000 \times 60 \times 24 = 23.04 \text{ млн}$&nbsp;&nbsp;&nbsp;&nbsp;  **(4)**
**Ежедневный входящий трафик**:&nbsp;&nbsp;
$\text{Количество роликов} \times \text{Вес ролика} = 23.04 \times 10^6 \times 25.78 \text{ МБ} \approx 566.46 \text{ ТБ}$&nbsp;&nbsp;&nbsp;&nbsp; **(5)**  
...
$\text{DAU} \times \text{Просмотров на пользователя} \times \text{Вероятность лайка} = 875.736 \times 10^6 \times 117 \times 0.03 \approx 2.627 \text{ млрд}$&nbsp;&nbsp;&nbsp;&nbsp; **(6)**  
**Количество комментов в день**:
$\text{DAU} \times \text{Просмотров на пользователя} \times \text{Вероятность коммента} = 875.736 \times 10^6 \times 117 \times 0.02 \approx 2.05 \text{ млрд}$ **(7)**  
**Количество подписок в день**:
$\text{DAU} \times \text{Просмотров на пользователя} \times \text{Вероятность подписок} = 875.736 \times 10^6 \times 117 \times 0.001 \approx 102.5 \text{ млн}$&nbsp;&nbsp; **(8)**  
...
$$\text{DAU} \times \frac{\text{Просмотров на пользователя}}{5} = 875.736 \times 10^6 \times \frac{117}{5} = 875.736 \times 10^6 \times 23.4 \approx 20.492 \text{ млрд}$$ **(9)**  

**Средний RPS на чтение**:&nbsp;&nbsp;&nbsp;&nbsp;
$$\text{RPS}_{\text{avg}} = \frac{\text{RPD}}{86400 \text{ (секунд в дне)}} = \frac{20.492 \times 10^9}{86400} \approx 237179$$ &nbsp;&nbsp;  **(10)**  

**Пиковый RPS на чтение**: &nbsp;&nbsp;&nbsp;&nbsp; 
$$\text{RPS}_{\text{peak}} = \frac{\text{RPD} \times 0.2}{3600 \text{ (секунд в часе)}} = \frac{20.492 \times 10^9 \times 0.2}{3600} \approx 1138457$$ &nbsp;&nbsp;  **(11)**
...
$$\text{RPS}_{\text{avg}} = \frac{\text{RPD}}{86400 \text{ (секунд в дне)}} = \frac{4.84754 \times 10^9}{86400} \approx 56106$$ &nbsp;&nbsp; **(13)**  

**Пиковый RPS на запись**:&nbsp;&nbsp;&nbsp;&nbsp;
$$\text{RPS}_{\text{peak}} = \frac{\text{RPD} \times 0.2}{3600 \text{ (секунд в часе)}} = \frac{4.84754 \times 10^9 \times 0.2}{3600} \approx 269308$$ &nbsp;&nbsp; **(14)**
