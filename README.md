...
|----------------------|---------------------------------------|----------|--------------|---------------|---------------|------------|
| Просмотр ролика      | Video, Workers, Syncs, Event Worker   | Сложный  | 77032        | 154-385       | 37.6-150.4    | 122.8 МБ/с |
...
| Лайк/дизлайк         | Video Reaction, Workers, Event Worker | Простой  | 2619         | 1             | 0.128-0.384   | 154 КБ/с   |
...
| Recommend system     | Ranker, Recommender, filter, workers  | Сложный  | ?            | ?             | ?             | ?          |
| API Gateway          | API Gateway                           | Простой  | 81623        | 9-17          | 0.4-1.2       | 124 МБ/с   |
| Envoy                | Envoy                                 | Простой  | 81623        | 9-17          | 0.4-1.2       | 124 МБ/с   |


| Таблица                | QPS       | Объем индекса<br>Через 10 лет | Общий объем<br>Через 10 лет | CPU (cores) |
|------------------------|-----------|-------------------------------|-----------------------------|-----------
| **`USER`**             | 81.086    | 596.4575 GB                   | 3.125 TB                    | 9
| **`USER_COUNTERS`**    | 771       | 83.78 GB                      | 210 GB                      | 0.07
| **`VIDEO`**            | 1.541.182 | 9.8 TB                        | 308.4 TB                    | 155
| **`VIDEO_COUNTERS`**   | 1.613.990 | 2.8 TB                        | 12.28 TB                    | 162
| **`COMMENT`**          | 108.090   | 278.325 TB                    | 443.5 GB                    | 1
| **`COMMENT_COUNTERS`** | 100.613   | 55.675 TB                     | 2.04 PB                     | 1
| **`USER_SESSION`**     | 10.191    | 373.99 GB                     | 112 TB                      | 0.05
