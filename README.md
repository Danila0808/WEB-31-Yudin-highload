...
Научный руководитель: Дмитрий Лозицкий  
...
### Размер таблицы после денормализации       


| Метрика / Таблица    | Расчёт (bytes)                                                                                                                                                                                                                                                                                                             | Вес одной записи (bytes) |      Количество записей | Итоговый вес таблицы |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -----------------------: | ----------------------: | -------------------: |
| **USER**             | 16 (**id**) + 32 (**username**) + 64 (**password**) + 64 (**email**) + 4 (**status**) + 200 (**avatar_url**) + 200 (**bio**) + 16 (**embedding_id**)                                                                                                                                                                       |                  **596** |   $2.249 \times 10^{9}$ |          **1.25 TB** |
| **USER_COUNTERS**    | 16 (**user_id**) + 8 (**followers_count**) + 8 (**following_count**) + 8 (**updated_at**)                                                                                                                                                                                                                                  |                   **40** |   $2.249 \times 10^{9}$ |            **84 GB** |
| **VIDEO**            | 16 (**video_id**) + 16 (**user_id**) + 100 (**title**) + 500 (**description**) + 200 (**video_url**) + 200 (**thumbnail_url**) + 8 (**upload_date**) + 16 (**parent_video_id**) + 4 (**type**) + 32 (**username**) + 200 (**ava_url**) + 100 (**parent_video_title**) + 200 (**parent_video_url**) + 16 (**embedding_id**) |                 **1608** |    $76.7 \times 10^{9}$ |        **123.36 TB** |
| **VIDEO_COUNTERS**   | 16 (**video_id**) + 8 (**views_count**) + 8 (**likes_count**) + 8 (**comments_count**) + 8 (**favourites_count**) + 8 (**shares_count**) + 8 (**updated_at**)                                                                                                                                                              |                   **64** |    $76.7 \times 10^{9}$ |          **4.91 TB** |
| **USER_SESSION**     | 16 (**session_id**) + 64 (**token**) + 16 (**user_id**) + 8 (**created_at**) + 8 (**updated_at**) + 8 (**expires_at**)                                                                                                                                                                                                     |                  **120** |   $1.582 \times 10^{9}$ |         **177.4 GB** |
| **COMMENT**          | 16 (**comment_id**) + 16 (**user_id**) + 16 (**video_id**) + 300 (**text**) + 8 (**created_at**) + 16 (**parent_id**) + 32 (**username**) + 200 (**ava_url**)                                                                                                                                                              |                  **604** |   $1.53 \times 10^{12}$ |         **836.5 TB** |
| **COMMENT_COUNTERS** | 16 (**comment_id**) + 8 (**likes_count**) + 8 (**updated_at**)                                                                                                                                                                                                                                                             |                   **32** |   $1.53 \times 10^{12}$ |          **44.8 TB** |
| **VIDEO_REACTION**   | 16 (**video_reaction_id**) + 16 (**user_id**) + 16 (**video_id**) + 4 (**type**) + 8 (**created_at**)                                                                                                                                                                                                                      |                   **60** |  $8.259 \times 10^{12}$ |         **450.2 TB** |
| **COMMENT_REACTION** | 16 (**comment_reaction_id**) + 16 (**user_id**) + 16 (**comment_id**) + 4 (**type**) + 8 (**created_at**)                                                                                                                                                                                                                  |                   **60** |  $1.467 \times 10^{12}$ |          **88.0 TB** |
| **SUBSCRIPTION**     | 16 (**subscription_id**) + 16 (**subscriber_id**) + 16 (**channel_id**) + 8 (**created_at**)                                                                                                                                                                                                                               |                   **56** | $218.636 \times 10^{9}$ |          **11.9 TB** |
| **FAVOURITE**        | 16 (**favourite_id**) + 16 (**user_id**) + 16 (**video_id**) + 8 (**added_at**)                                                                                                                                                                                                                                            |                   **56** |  $1.224 \times 10^{12}$ |          **68.4 TB** |
| **EVENT**            | 16 (**event_id**) + 16 (**user_id**) + 16 (**video_id**) + 4 (**type**) + 8 (**timestamp**) + 16 (**reference_id**) + 16 (**session_id**) + 256 (**details JSONB**)                                                                                                                                                        |                  **348** |   $2.12 \times 10^{12}$ |         **742.6 TB** |
| **EMBEDDING_META**   | 16 (**embedding_id**) + 64 (**model_name**) + 4 (**model_version**) + 6144 (**vector**) + 8 (**created_at**) + 8 (**updated_at**)                                                                                                                                                                                          |                 **6244** |  $78.949 \times 10^{9}$ |         **462.9 TB** |
| **SEARCH_VIDEO**     | 16 (**search_id**) + 16 (**video_id**) + 100 (**title**) + 200 (**url**) + 8 (**likes**) + 8 (**upload_date**) + 200 (**author_ava**) + 32 (**author_username**) + 16 (**author_id**) + 256 (**TSVECTOR**)                                                                                                                 |                  **852** |    $76.7 \times 10^{9}$ |          **65.3 TB** |
| **SEARCH_USER**      | 16 (**search_id**) + 16 (**user_id**) + 32 (**username**) + 200 (**bio**) + 200 (**ava_url**) + 8 (**followers**) + 256 (**TSVECTOR**)                                                                                                                                                                                     |                  **728** |   $2.249 \times 10^{9}$ |          **1.52 TB** |
...
| Сценарий | Таблица | Поля индекса | Объём одной записи (байт) | Количество записей | Общий объём индекса |
|---------|--------|--------------------------------------|---------------------------|---------------------|---------------------|
| **Поиск пользователя по user_id** | `USER` | `id` | 16 | $2.249 \times 10^{9}$ | **33.513 GB** |
| **Поиск пользователя по никнейму** | `USER` | `username` | 32 | $2.249 \times 10^{9}$ | **67.02 GB** |
| **Поиск пользователя по почте** | `USER` | `email` | 64 | $2.249 \times 10^{9}$ | **134.05 GB** |
| **Поиск счетчиков по user_id** | `USER_COUNTERS` | `user_id` | 16 | $2.249 \times 10^{9}$ | **33.513 GB** |
| **Найти видеокролик по video_id** | `VIDEO` | `video_id` | 16 | $76.7 \times 10^{9}$ | **1.12 TB** |
| **Найти родительский ролик (Duet/Stitch)** | `VIDEO` | `parent_video_id` | 16 | $76.7 \times 10^{9}$ | **1.12 TB** |
...
### Система рекоммендаций (For you page) и алгоритм оптимизации поиска  
&nbsp;&nbsp;&nbsp;&nbsp; Главная идея системы рекоммендаций состоит в выборе наиболее подходящий видеороликов для определенного пользователя. Она состоит из 4 основных состовляющих. Первое это перевод видео, текст, аудио и пользователй в векторную систему для работы машинного обучения. После того, как переведены объекты в необходимое пространство, следует применить такой алгоритм обучения построения векторов, чтобы можно было оценить взаимосвязь между пользователем и видео.


**1. Video Ingestion & Feature extraction**
&nbsp;&nbsp;&nbsp;&nbsp; Этот этап представляет собой совокупность энкодеров, которые переводят файлы типов mp4, wav, txt в векторный вид следующих образом - чтобы видео и все его состовляющие схожей тематики имели наименьший угол между векторами. Это необходимо для того, чтобы система различала видео разных категорий.
* **CLIP** (Contrastive Language–Image Pre-training)
	+ Модель, разработанная OpenAI, которая обучается понимать связь между изображениями и текстовыми описаниями. Основная инновация — создание единого пространства представлений, где векторы изображений и соответствующих им текстов находятся близко друг к другу. 
 	+ Он работает благодаря **Vision Transformer (ViT)** - энкодер изображения, который embed(ит) ролик.
 		- Изображение разделяется на патчи. 1 патч обычно 16 на 16 пикселей. Задается глубина кодирования, размер патча и оно разделяется с учетом его положения.
   		- Задается матрица весов $P \times L, где P=16 \times 16 \times С$; C-глубина кодирования. А L - множество факторов идентификации, которые различают на уровни.
     	- Низкоуровневые признаки: Границы и контуры; Углы и линии; Цветовые переходы; Простые текстуры; Яркостные градиенты
      	- Среднеуровневые признаки: Геометрические формы (круги, треугольники); Текстуры (полосатые, пятнистые, гладкие); Простые паттерны; Относительные положения элементов
      	- Высокоуровневые признаки: Объекты (лица, машины, животные); Части объектов (глаза, колеса, лапы); Сцены (пейзажи, интерьеры); Действия (бег, прыжок, еда)
      	- Матричные веса задаются случайно. Далее результат нормализуется, например с помощью **сигмоиды**
      	- Рассчитывается **MSE**. И с помощью алгоритма **Back-Propagation** обновляются веса
      	<img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/fa99648a-b6c4-492a-bd9f-964998baee4c" />
		<img width="1213" height="424" alt="image" src="https://github.com/user-attachments/assets/b9a4e7e1-5ede-476d-8f00-5a4537c9792c" />
	+ Добавляется к исходной матрице эмбедингов позиционные вектора (обозначающие местоположение на изображении).
 	+ В конец исходной матрицы конкатинируется вектор псевдо-патча CLS, который не содержит полезной информации. Служит для дальнейшего шага - сбоора информации от всех других патчей. Он и будет выходным эмбедингом
  	+ **Трансформаторный энкодер** - корректирует эмбединги, добавляя логику связи между патчами
		- Ядром энкодера является 3 обучаемые матрицы: Q (Query), K (key), Value (value). Это матрицы внимания "головы". Весь энкодер разделяется на головы. Каждая голова корректирует исходную матрицу с определенной точки зрения (семантика, пространственный анализ). Первая является своего рода фильтром, который зануляет ненужные для запроса комоненты и усиливает необходимые. Вторая - матрица представления. Она корректирует матрицу в целях точного представления. Последняя является произведением матриц: $q=Q_i \times X; k = K_i \times X; V = q \times k^{T}$. Обучаются они также методом **back-propogation**. Для этого нужно знать для каждой головы, для каждого патча значимость отношения к другим патчам.
  		- С поомщью функции softmax значения вектора преобразуются к формату вероятности (0-1).
  	 	- Для того, чтобы нормализовать данные используется классическая формалу нормализации. Далее по каждой голове компоненты складываются.
  	  	- Вектор под токеном CLS будет выходом. 
		<img width="640" height="390" alt="image" src="https://github.com/user-attachments/assets/e10ab7fb-0a2f-4f6e-a5fe-919ada3719e1" />
		<img width="663" height="157" alt="image" src="https://github.com/user-attachments/assets/0830a5de-55df-4305-a3ba-9be65c1fd050" />
	+ Используется технология BERT для эмбединга текста.
 	+ С помощью формулы косинусной схожести определеятся матрица схожести между веторами видео и текста
 	<img width="1352" height="482" alt="image" src="https://github.com/user-attachments/assets/a55bc590-5ee3-4320-919d-8e124b16d0ca" />
  	+ Для нормализации используется softmax и для вычисления ошибки - **logloss**
  	<img width="589" height="153" alt="image" src="https://github.com/user-attachments/assets/d51ca74f-6da4-42d7-a4a9-fb1a7ea21e3f" />
  	+ С помощью backpropogation корректируются матрицы Q и K для энкодера видео и текста.

* **Bert** (Bidirectional Encoder Representations from Transformers)
	+ _Инициализация_: Задается очень большой текст (целое произведение). Создается пустой массив. Далее текст разбивается по буквенно.
 	+ За O(n) проходится по массиву и находит самые часто повторяющиеся пары букв. При опрделенном числе повторений - пара объявляется токеном. Далее она действует в тексте как единое целое.
  	+ Процесс повторяется до тех пор, пока словарь не достигнет определенного объема или когда потенциальные токены перестают повторяться в тексте. Таким образом система понимает все составные части слова и может формировать из них существующие слова.
  	+ В словарь добавляется дополнительно несколько служебных токенов, таких как CLS, MASK, SEP. Они служат для обучения и разграничения.
  	+ Embedding формируется за счет 3ех состовляющих - Token, Segment, Postion embeding. Это обучаемые матрицы, которые обозначают 1) смысл 2) принадлежность к одному предложению 3) позицию в предложении.
  	+ После векторизации текста используетсся та же архитектура, что и в ViT. Создаются матрицы запроса, ключа и значения. Которые обучаются распозновать смысл между токенами.
  	+ Далее используется алгоритм MLM (Masked Language Model). Где случайный токен заменяется служебным MASK. И цель заключается в том, чтобы смысл предложения не терялся из-за пропущенного слова.
  	+ Далее используется алгоритм NSP (Next Sentence Prediction). Где текст разделяется на предложения, разделенные токеном SEP. И с помощью logloss определяется смысловая принадлежность между предложениями.
  	+ На этом этапе разные языковые модели используют разные модели. Для системы поиска и рекоммендаций результатный эмбединг для текста будет достаточен.

3. Candidate generation  
&nbsp;&nbsp;&nbsp;&nbsp; У системы миллиарды объектов — ранжировать все нельзя. Поэтому сначала извлекают K элементов эмбеддингов-видео. И рассчитывается score с помошью косинусной сходимости.
<img width="350" height="93" alt="image" src="https://github.com/user-attachments/assets/c0640042-37b3-4c7e-aa78-2de95ce67bd8" />
<img width="608" height="77" alt="image" src="https://github.com/user-attachments/assets/83c23ba6-d692-4a00-9d16-2495a9d9e002" />


4. Ranking & Scoring
Функция ошибки на основе которой обучается вектор пользлвателя рассчитывается по следующей формуле:
<img width="523" height="89" alt="image" src="https://github.com/user-attachments/assets/abfee5d8-8d03-42ea-8a18-87314bbda100" />
...
| Компонент | Описание резервирования |
|------------|--------------------|
| 1 Дата-центр в регионе | **BGP Anycast** автоматически перенаправит весь трафик в другой дата-центр на основе метрик BGP. |
| Все дата-центры в регионе | **geoDNS** вернёт IP-адрес дата-центра из другого региона как резервный вариант. |
| Edge Envoy | Используется keep-alive баланировка с протоколом **VRRP**. Если падает master, актуальный MAC берет standby. |
| Istio Gateway | Также как и любой другой компонент является подом. Может быть зареплицирован с помощью **Kubernetes**. |
| Pod микросервиса | **k8s** контроллер уровня Control Plane kube-controller-manager следит за количеством и состоянием подов в соответстствии с конфигурацией и данными из etcd. |
| Cassandra | Replica-factor = 3 - означает, что хранятся дополнительно хэши 2ух соседних нод. Реализовано под капотом |
| Redis | Leader-Follower отношение. Записывать можно только в одну, читать из нескольких. **Redis Sentinel** - Отдельный сервис (набор процессов), который мониторит экземпляры Redis и выполняет автоматическое переключение при отказе ведущего. Sentinel сам по себе является распределенной системой  |
| ClickHouse | **ZooKeeper** - Хранит метаданные о репликации (лог репликации, состояние реплик, метаданные о партициях и т.д.). При изменении данных (вставка, удаление) в одной из реплик, она записывает информацию в ZooKeeper, а другие реплики читают из ZooKeeper и применяют изменения. |
| Milvus | Использует архитектуру с разделением ролей (разделение на компоненты: query node, data node, index node, etc.). Для координации и хранения метаданных Milvus использует **etcd**. Используется для хранения метаданных (метаданные коллекций, сегментов, индексов, информация о шардировании и репликации). Также используется для выбора лидера и сервиса обнаружения. Также желательно подключению к брокеру сообщений (Kafka), которая обновляет данные во всех репликах |
| Elastik Search | Работает на основе **Apache Lucene**. Вся архитектура состоит из набора кластеров, которые делятся на ноды. Они подразделяются по ролям (мастер, данные, координация). Все операции записи (добавление, обновление, удаление документа) отправляются только в первичный шард. После обработки операции первичный шард параллельно пересылает ее на все свои шарды-реплики. Запросы на чтение могут обрабатываться как первичным шардом, так и любой из его реплик. |
| Kafka | Для каждой партиции один брокер становится лидером, остальные — последователями. Все операции записи идут только в лидера партиции. Данные реплицируются на последователей. In-Sync Replicas (ISR): Список реплик, которые не отстают от лидера. За их состоянием следит Controller Kafka. Работает под капотом. |
| S3 | AWS автоматически реплицирует данные, но для безопасноти можно воспользоваться защитным механизмом **Cross-Region-Replication** |
| CDN PoP | В случае падения одной точки **CloundFront** направит трафик на другой PoP. |  


### Асинхронный паттерн


**CQRS** (Command Query Responsibility Segregation) - это архитектурный паттерн, который разделяет поток операций чтения (Query) и записи (Command) на уровне логики и модели данных в приложении. Операции чтения не могут изменять состояние, а операции записи не должны возвращать данные. Для каждой операции проектируется отдельный обработчик; модели могут храниться даже в разных БД, оптимизированных каждая для своей задачи (например, OLTP для записи и OLAP/кэш — для чтения). Такая схема помогает повысить масштабируемость, производительность и управляемость сложных бизнес-систем.  
Плюсы:  
* Масштабируемость: Позволяет масштабировать операции чтения и записи независимо, что критично в системах с неравномерной нагрузкой.
* Надежность и тестируемость: Код становится более модульным, модели проще тестировать и поддерживать.
Минусы:
* Усложнение архитектуры
* Наличие временного лага при записи


### Синхронизация данных

**Event-driven (EDA)** архитектура — это концепция программирования, которая позволяет создавать сложные приложения, используя событийно-ориентированный подход. Основная идея заключается в том, что все действия в приложении основаны на событиях. Это позволяет создавать распределенные системы, которые легко масштабируются и обладают высокой отказоустойчивостью. EDA строится на асинхронной неблокирующей коммуникации между производителями и потребителями событий. Это позволяет компонентам освобождать ресурсы во время ожидания ответа, что принципиально отличается от синхронных request-response моделей.  
Состоит из 3 главных составляющих:
* Производители событий (Event Producers)
* Потребители событий (Event Consumers)
* Event Broker (Message Bus)  
<br>
Требует реализации дополнительных паттернов:
* CQRS
* Database per service
* Event Sourcing
<br>
Главное преимушество - поддержка консистентности данных в различных баз данных без использования распределенных транзакций  
<br>
Ключевые настройки:
* _acknowledge = all_ - операция синхронизации завершается только тогда, когда все сервисы потдвердили получение и запись данных.
* _Idempotency_. Настройка не позволяет добавлять дублирующиеся записи в брокер.
* _Consistency checks_. Для надежности можно создать CronJob, который будет проверять и компенсировать ошибки консистентности.



### Физическая надежность  
* **Горячий/холодный коридор**:
	+ Серверные стойки выстраиваются рядами лицевыми панелями друг к другу — между ними образуется холодный коридор, куда подается охлажденный воздух.​
 	+ Задние панели стоек выходят в горячий коридор, откуда нагретый воздух удаляется и не смешивается с холодным.​
  	+ Физическая изоляция коридоров (двери, крыши, шторы) обязательна при мощности более 5 кВт на стойку.
	+ Резервирование систем охлаждения - Дублирование кондиционеров, насосов, чиллеров по формуле 2(N+1).
	+ Мониторинг температуры
* Использование уровня надежности **Tier IV** (максимальная отказоустойчивость)
	+ Полное дублирование всей инфраструктуры по схеме 2(N+1)
 	+ Полная физическая разнесенность критических систем по разным помещениям
  	+ Как минимум 2 независимых источника питания от разных сетей
  	+ Структурированная кабельная система полностью продублирована
  	+ Использование ДГУ (дизель-генераторной установки)
* Регулярное техобслуживание
* Защита от внешних угроз:
 	+ Датчики дыма и температуры с автоматической активацией тушения.
  	+ Дренажные системы и водонепроницаемые барьеры.
  	+ Многоуровневый контроль доступа (биометрия, карты, коды).
  	+ Видеонаблюдение 24/7 с архивированием записей.
  	+ Охрана периметра, турникеты, шлюзы.

### Сегментирование 


Разделение по группам API:
* Сессия: регистрация, авторизация, профиль
* Просмотр: загрузка/выгрузка видеоролика
* Система рекоммендаций: поиск видео, поиск пользователя, лента, работа с ML
* Реакции: лайк, подписка, избранное, share, комментарии

Полная изоляция групп между собой. Строгая маршутизация. Разделение подов.


### Fail-over policy


&nbsp;&nbsp;&nbsp;&nbsp; Автоматическое переключение ресурсов для сохранения полной работоспособности таким образом, чтобы пользователь не видил изменений.
1. _Конфигурация Istio Envoy на cirquit breaker_: Задать количество таймаутов после которых будет переключение на fallback.
2. _Закэшировать данные на Frontend_: Например запоминать под какими видео стоял лайк и отображать его нажатым, даже если сервер не отвечает. При перезагрузке - все равно те же видео не покажутся
3. _Альтернативная логика_: Поиск не с помощью Elastik Search а по названию видео или пользователей. Или загружать не рекоммендованные ролики, а трендовые.


### Graceful Shutdown


1. Предупреждение пользователей о технических работах.
2. Запретить podам получать новый трафик
3. Настроить Envoy на закрытие соединений с Sidecar.
4. Controlled Shutdown Kafka
5. Nodetool decommission Cassandra


### Graceful Degradation


&nbsp;&nbsp;&nbsp;&nbsp; Упрощение/ограничение функциональности для сохранения частичной работоспособности с целью, чтобы пользователь максимум увидел уменьшение возможностей, но не безответность от сервиса.
1. Система рекоммендаций - топ трендовых видеороликов
2. Поиск - прямой текстовый поиск по названию без ML
3. Реакция - закэшировать и отправить позже
...
* **RUM** (Real User Monitoring)
	+ Page Load Time, TTI (time to interactive) Error Rate (network), Session duration
 	+ _New Relic_, _AWS CloudWatch RUM_, _собственный JS код_
* **Synthetic Monitoring**
	+ Response Time, Latency, Jitter, Page Load Speed
 	+ _AWS Synthetics_, _Datalog Synthetics_
* **External Monitoring**
	+ Packet loss, bandwidth, traceroute
 	+ _Pingdom_, _ThousandEyes_, _uptimerobot_

### Alerting  


**Prometheus** собирает метрики в режиме реального времени (загрузка CPU/памяти, latency микросервисов, ошибки, состояние репликации БД), а **Grafana** визуализирует их на дашбордах.<br>
* Prometheus содержит встроенный механизм для генерации алертов на основе правил, написанных на языке PromQL. Когда метрика выполняет условие из правила (например, node_cpu_seconds_total > 80), Prometheus создает алерт и отправляет его в **Alertmanager**.<br>
* Alertmanager — это отдельный компонент, который получает алерты от Prometheus, группирует их (объединяет похожие), подавляет дубликаты и отправляет уведомления по конфигурируемым каналам.<br>
* Grafana может самостоятельно опрашивать Prometheus и создавать алерты без использования Alertmanager. Это встроенная система с UI для создания и управления правилами.<br>

Golang - **pprof** - профилировщик, отлеживающий состояние программы - сколько занимает процессорного времени, памяти, сколько потоков обслуживаются.  


## 11. Выбор оборудования и хостинга  


&nbsp;&nbsp;&nbsp;&nbsp;Модель развертывания - гибридная. Для stateless микросервисов желательно использовать k8s так как нет критичных рамок по задержке и ресурсам, но при этом Kubernetes позволит автоматически масштабироваться, следить за состоянием (health-check) и балансировать нагрузку. В то время как stateful сервисы (базы данных) лучше использовать решения без локальных сетей и дополнительной нагрузки - то есть развертывание на bare-metal. Для отдачи и загрузки медиа-контента следует сравнить облачное хранилище/аренда bare-metal или собственное решение. Для начала будет просчитана нагрузка для Kebenode и для каждой бд, а также для S3 хранилища. Далее в зависимости от требований и дешевизны будет выбрана хостинг модель  


### Kubenode


Ресурсы CPU, RAM для Go-микросервисов по уровню сложности на 1000 RPS.
| Сложность  | CPU (cores) | RAM (MB)    |
|------------|-------------|-------------|
| Простая    | 0.2         | 2 MB        |
| Средняя    | 10          | 1 GB        |
| Сложная    | 100         | 10 GB       |

|  MVP функционал      | Сервисы                               | Характер | RPS на 1 ДЦ  | CPU (cores)             | RAM (GB)              | Трафик        |
|----------------------|---------------------------------------|----------|--------------|-------------------------|-----------------------|---------------|
| Просмотр ролика      | Video, Workers, Syncs, Event Worker   | Средний  | 77032        | 770.32 — 1,925.80       | 77.032 — 192.580      | 122.8 МБ/с    |
| Просмотр профиля     | User, Syncs                           | Простой  | 4055         | 0.81 — 2.03             | 0.00792 — 0.01980     | 2.46 МБ/с     |
| Публикация ролика    | Upload Service                        | Простой  | 27           | 0.01 — 0.03             | 0.00005 — 0.00012     | 42 КБ/с       |
| Лайк/дизлайк         | Video Reaction, Workers, Event Worker | Простой  | 2619         | 0.52 — 1.30             | 0.00512 — 0.01280     | 154 КБ/с      |
| Комментарий          | Comment, Syncs                        | Средний  | 540          | 5.40 — 13.50            | 0.540 — 1.350         | 335.4 КБ/с    |
| Подписка             | Subscription, Syncs, Event Worker     | Простой  | 77           | 0.02 — 0.05             | 0.00015 — 0.00038     | 4.2 КБ/с      |
| Регистрация          | Auth Service                          | Простой  | 3            | 0.0003-0.0006           | 0.00001 — 0.00003     | 2.2 КБ/с      |
| Поделиться           | Share Service, Syncs, Event woker     | Простой  | 154          | 0.03 — 0.08             | 0.00030 — 0.00074     | 8.4 КБ/с      |
| Добавить в избранное | Favourite Service, Syncs, Event worker| Простой  | 431          | 0.09 — 0.21             | 0.00084 — 0.00210     | 23.5 КБ/с     |
| Поиск                | Ranker, Searcher, filter, workers     | Простой  | 740          | 0.15 — 0.37             | 0.00145 — 0.00361     | 1.12 МБ/с     |
| Recommend system     | Ranker, Recommender, filter, workers  | Сложный  | 4055         | 405.50 — 1,013.75       | 40.550 — 101.375      | 6.18 МБ/с     |
| API Gateway          | API Gateway                           | Простой  | 89733        | 17.95 — 44.88           | 0.17526 — 0.43815     | 133.13 МБ/с   |
| Envoy                | Envoy                                 | Простой  | 89733        | 17.95 — 44.88           | 0.17526 — 0.43815     | 133.13 МБ/с   |
| Итого                |                                       |          | **269199**   | **1,218.75 — 3,046.88** | **118.488 — 296.221** | **399.4 МБ/с**|


Следует рассмотреть коэффициент запаса. Рассмотрим регион Южной Америки, где расположено 2 дата-центра. Для обеспечения fail-over политики необходимо, чтобы 1 дата-центр смог выдержать полную нагрузку в случае падения второго дата-центра.<br>
Считается стандартным брать коэффициент headroom порядка 40% (https://docs.hazelcast.com/hazelcast/5.6/capacity-planning). Но так как один дата-центра должен выдержать нагрузку второго, то должно быть не менее 60%. В таком случае коэффициент запаса необходимо брать:  
$$\text{coeff} = \frac{1}{1-0.6} = 2.5 \text{ раза}$$  
Итого требуется обеспечить:  
$$\text{CPU} = 1219 \times 2.5 = 3047 \text{ cores}$$  
$$\text{RAM} = 119 \times 2.5 = 297 \text{ GB}$$  


Для того, чтобы обработать такие нагрузки были выбраны следующая конфигурация сервера:
* CPU: AMD EPYC™ 9965[^19] - 192 ядер; 384 потоков; 2.25-3.35 GHz; 384 MB L3 cache, TDP=500 W, socket=sp5 - 2x14813 USD = 29626 USD 
* Motherboard: T3ADEC Server Board[^20] - 16(8×2) DDR5, 2s sp5 - 998 USD
* RAM[^21]: 16x16 GB DDR5 5.6 GHz - 16 * (199 USD) = 3184 USD
* Остальное:
	+ Корпус и охлаждение: Hyper A+ Server AS -2125HS-TNR - 3700 USD
 	+ Память: NVMe 460 GB - 190 USD  
Итого: 37698 USD

${3057 \text{cores}}/{384 \text{cores}} \approx 8$ - сервера для обеспечения процессорной мощности с резервом  
${256 \text{GB}} \times {8 \text{GB}} = 2048$ - количество памяти RAM для данной конфигурации

Как итог для обепечения необходимых мощностей с учетом резерва было взято 8 серверов с вышеперечисленной конфигураций с приблизительной стоимостью за штуку 37698 USD.  
Общая стоимость развертывания - 301.584$  
Амортизация за 5 лет: **5.026$/месяц**  


### Хостинг kubenodes  

https://aws.amazon.com/eks/pricing/ - ссылка на AWS прайслист  
https://instances.vantage.sh/ - ссылка на конфигурацию сервера

Конфигурация схожая с вышеописанной - m5.8xlarge, которая предоставляет 48 ядер и 128 гб ОЗУ<br>
${3057 \text{cores}}/{48 \text{cores}} \approx 64$ - сервера для обеспечения процессорной мощности с резервом  
Стоимость - 0.18432$/час. Или 720*0.18432=132.71$/мес<br>
Итого требуется 64 * 132.71$ = **8.493,44$/мес**


### Data Base


| Таблица                | QPS       | Объем индекса<br>Через 10 лет | Общий объем<br>Через 10 лет | CPU (cores) |
|------------------------|-----------|-------------------------------|-----------------------------|-------------|
| **`USER`**             | 81.086    | 596.4575 GB                   | 3.125 TB                    | 9           |
| **`USER_COUNTERS`**    | 81.857    | 83.78 GB                      | 210 GB                      | 0.07        |
| **`VIDEO`**            | 1.541.182 | 9.8 TB                        | 308.4 TB                    | 155         |
| **`VIDEO_COUNTERS`**   | 1.613.990 | 2.8 TB                        | 12.28 TB                    | 162         |
| **`COMMENT`**          | 108.090   | 278.325 TB                    | 2.04 PB                     | 1           |
| **`COMMENT_COUNTERS`** | 100.613   | 55.675 TB                     | 112 TB                      | 1           |
| **`USER_SESSION`**     | 10.191    | 373.99 GB                     | 443.5 TB                    | 0.05        |
| **`VIDEO_REACTION`**   | 52.386    | 901 TB                        | 1.1 PB                      | 0.5         |
| **`COMMENT_REACTION`** | 3.309     | 220.56 TB                     | 220 TB                      | ~0          |
| **`SUBSCRIPTION`**     | 1.542     | 48.27 TB                      | 29.75 TB                    | ~0          |
| **`FAVOURITE`**        | 8.628     | 175.98 TB                     | 171 TB                      | ~0          |
| **`EVENT`**            | 1.718.417 | 264.175 TB                    | 742.6 TB                    | 2           |
| **`SEARCH_USER`**      | 15.334    | -                             | 3.8 TB                      | 184         |
| **`SEARCH_VIDEO`**     | 14.856    | -                             | 163.25 TB                   | 178         |
| **`EMBEDDING_META`**   | 81.100    | 2.875 TB                      | 1.13 PB                     | 973         |
| **`S3`**               | 1.730.358 |                               | 2929 PB                     |             |  


Рассчитаем общий QPS проходящий через Kafka:

$$QPS = 52.386 + 3.309 + 8.628 + 1.542 = 65865$$
$$Traffic = 52.386 \times 60 + 3.309 \times 60 + 1.542 \times 56 + 8.628 \times 56 = 3.911.220\ Bytes = 3.73\ MB$$
$$Week\ Traffic = 3.73 \times 86400 \times 7 = 2.255.922\ MB = 2.15\ TB$$
$$RF\ Traffic = 2.15 \times 3 = 6.45\ TB$$


| База данных            | Nodes cnt | RAM/node      | ROM/node * RF | CPU (cores)/node | Конфигурация                                | Стоимость |
|------------------------|-----------|---------------|---------------|------------------|---------------------------------------------|-----------|
| **Cassandra**          | 8192      | 211.68 GB     | 1.49 TB       | 0.04             | AMD EPYC 7313P 16c, 8x32GB RAM, 1×2TB NVMe  | $34.4M    |
| **ClickHouse**         | 1024      | 264.18 GB     | 2.17 TB       | 0.002            | AMD EPYC 7313P 16c, 16x32GB RAM, 2×2TB NVMe | $4.915M   |
| **Kafka**              | 8         | 137.6 GB      | 826 GB        | 0.17             | AMD EPYC 7313P 16c, 8x32GB RAM, 1×1TB NVMe  | $24K      |
| **Redis**              | 32        | 11.67 GB      | 41.57 TB      | 0.001            | AMD EPYC 7313P 16c, 1x32GB RAM, 3×16TB NVMe | $208K     |
| **Elastik Search**     | 128       | 16 GB         | 3.9 TB        | 2.82             | AMD EPYC 7313P 16c, 1x32GB RAM, 2×2TB NVMe  | $448K     |
| **Mivus**              | 64        | 46 GB         | 54.24 TB      | 16               | AMD EPYC 9454P 48c, 2x32GB RAM, 4×16TB NVMe | $704K     |
| **Итог**               | 9448      | 2 PB          | 19.7 PB       | 153.216          |                                             | $40.7M    |


Амортизация за 5 лет: **678.333$/месяц**<br>


### Хостинг  


Данные взяты с сайта Cherry servers (https://www.cherryservers.com/)


| База данных            | Nodes cnt | Конфигурация                                | Цена/мес (1 нода) | Итог/мес   |
|------------------------|-----------|---------------------------------------------|-------------------|------------|
| **Cassandra**          | 8192      | AMD EPYC 7313P 16c, 8x32GB RAM, 1×2TB NVMe  | $320              | $2.621M    |
| **ClickHouse**         | 1024      | AMD EPYC 7313P 16c, 16x32GB RAM, 1×4TB NVMe | $450              | $460K      |
| **Kafka**              | 8         | AMD EPYC 7313P 16c, 8x32GB RAM, 1×1TB NVMe  | $360              | $2.8K      |
| **Redis**              | 32        | AMD EPYC 7313P 16c, 1x32GB RAM, 3×16TB NVMe | $350              | $11.2K     |
| **Elastik Search**     | 128       | AMD EPYC 7313P 16c, 1x32GB RAM, 1×4TB NVMe  | $200              | $25.6K     |
| **Mivus**              | 64        | AMD EPYC 9454P 48c, 2x32GB RAM, 4×16TB NVMe | $850              | $54.4K     |
| **Итог**               | 9448      |                                             | $2.530            | **$3.176.320** |


### S3


https://aws.amazon.com/s3/pricing/ - ссылка на прайслист AWS S3  
Цена за Гигабайт размешенной памяти в месяц - 0.0021 dollars/(GB*мес)
Объем данных который необходимо разместить - 2929 PB  

Итого: <br>
$$2929 \text{PB}\times{0.0021 \text{ dollars/(GB*мес)}} = **64.496.861** \text{ dollars/мес}$$ - размещение на AWS S3  

Объем хранилища через 5 лет: 7322.5 PB  
Архитектура СХД: 
* Платформа[^22]: SuperServer SSG-640SP-E1CR90, который поддерживает 90 3.5" SATA3 2xNVMe - 10500 USD
* CPU: 2x Intel Xeon Silver 4314, 16c - 1400 USD
* RAM: 0.01% буфер - 4x64GB DDR4 - 600 USD
* SSD: 1x480GB NVMe + 1x3.84TB NVMe - 1820 USD
* HBA: Broadcom 9500-16i - 450 USD
* Сетевая карта: Mellanox ConnectX-6 Dx - 900 USD
* HDD: 90xSeagate Exos X22 - 90x22TB (1980 TB) - 31500 USD
* ИТОГО: _47170 USD/1980 TB_  

Вместо RAID исполузуем Erasure Coding 8+3 с 72% эффективностью для достижения отказоустойчивости (по принципу RAID6, но катомный на SDS)  
$8/11 \approx 72.7%$ - эффектисноть надежности  
$7322.5 PB \times \frac{1}{72.7%} = 10068.43 PB$ - Количество необходимого обеспечения памятью  
$frac{10068.43 PB}{1.93 PB} \approx 5217$ - Количество серверов к покупке  
$5217 \times 47170 \approx 246.085.890 USD$ - Общая стоимость хранилища на 10 лет вперед с отказоустойчивостью и надежностью  

Амортизация за 5 лет: 246.085.890/60 = **4.101.431,5 USD** 
...
[^19]: [Процессор для сервера](https://www.amd.com/en/products/processors/server/epyc/9005-series/amd-epyc-9965.html)
[^20]: [Материнская плата для сервера](https://www.ebay.com/itm/389020650154)
[^21]: [ОЗУ для сервера](https://www.ebay.com/itm/177404242921)
[^22]: [Плафтформа под СХД](https://www.supermicro.com/en/products/system/storage/4u/ssg-640sp-e1cr90)
