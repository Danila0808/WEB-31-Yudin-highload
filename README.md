...
**Prometheus** собирает метрики в режиме реального времени (загрузка CPU/памяти, latency микросервисов, ошибки, состояние репликации БД), а **Grafana** визуализирует их на дашбордах.
