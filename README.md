...
$\frac{\text{Количество роликов за все время}}{\text{Количество зарегистрированных}} = \frac{76.7}{2.249} \approx 34.1\text{ шт}$&nbsp;&nbsp;&nbsp;&nbsp; **(6)**  
**Общее количество комментариев под всеми роликами**:&nbsp;&nbsp;
$\text{Средний размер хранилища пользователя} \times \text{Кол-во комментариев} = 34.1 \times 225 \approx 7875\text{ шт}$&nbsp;&nbsp;&nbsp;&nbsp; **(7)**  
**Вес комментариев под всеми роликами**:&nbsp;&nbsp;
$\text{Среднее количество символов в комментарии} \times \text{кодировка UTF-8} \times \text{Количество комментариев} = 50 \times 1 \times 7875 = 384.5 \text{ KB}$$&nbsp;&nbsp;&nbsp;&nbsp; **(8)**  
**Средний размер хранилища пользователя (ГБ)**:&nbsp;&nbsp;  
$\text{Средний размер хранилища пользователя} \times \text{Вес ролика} = 34.1 \times 40 = 1.36\text{ GB}$&nbsp;&nbsp;&nbsp;&nbsp; **(9)**
...
$\text{DAU} \times \text{Просмотров на пользователя} \times \text{Вероятность лайка} = 875.736 \times 10^6 \times 76 \times 0.034 \approx 2.263 \text{ млрд}$&nbsp;&nbsp;&nbsp;&nbsp; **(10)**  
**Количество комментов в день**:   
$\text{DAU} \times \text{Просмотров на пользователя} \times \text{Вероятность коммента} = 875.736 \times 10^6 \times 76 \times 0.007 \approx 465.9 \text{ млн}$$&nbsp;&nbsp;&nbsp;&nbsp; **(11)**  
**Количество подписок в день**:   
$\text{DAU} \times \text{Просмотров на пользователя} \times \text{Вероятность подписок} = 875.736 \times 10^6 \times 76 \times 0.001 \approx 66.56 \text{ млн}$&nbsp;&nbsp;&nbsp;&nbsp; **(12)**  
**Количество регистраций в день**:   
$\frac{\text{Количество скачиваний в год}}{\text{Количество дней в году}} = \frac{875.67 \times 10^6}{365} \approx 2.4 \text{ млн}$&nbsp;&nbsp;&nbsp;&nbsp; **(13)**  
...
$$\text{DAU} \times \text{Просмотров на пользователя} = 875.736 \times 10^6 \times 76 \approx 66.556 \text{ млрд}$$&nbsp;&nbsp;&nbsp;&nbsp; **(14)**   

**Средний RPS на чтение**:&nbsp;&nbsp;&nbsp;&nbsp;
$$\text{RPS}_{\text{avg}} = \frac{\text{RPD}}{86400 \text{ (секунд в дне)}} = \frac{66.556 \times 10^9}{86400} \approx 770324$$ &nbsp;&nbsp;  **(15)**  
...
| ***Итог***       | ***69.3679 млрд***         | ***802976***| ***1605952***|
...
| Выпуск ролика    | 40 MB              | 10.43 GB/сек        |  20.86 TB/сек    |
...
![Main](https://github.com/user-attachments/assets/83a2dd7a-9a9f-4cca-b8a8-1ba3197d068e)
